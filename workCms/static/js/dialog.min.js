...
$.fn.dialog = function (options) {
    var id = options.id, _options$title = options.title, title = _options$title === void 0 ? "我的标题" : _options$title,
        _options$type = options.type, type = _options$type === void 0 ? 0 : _options$type,
        _options$easyClose = options.easyClose, easyClose = _options$easyClose === void 0 ? false : _options$easyClose,
        form = options.form, _options$submit = options.submit,
        submit = _options$submit === void 0 ? noSubmitFunc : _options$submit, _options$afterInit = options.afterInit,
